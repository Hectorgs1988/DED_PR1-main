...
public class ShippingLinePR1Test {
    ...
    public void addRouteTest() {
        ...
        this.theShippingLine.addRoute("routeId1000", "XXXX", "YYYYY");
        Route route1000 = this.theShippingLine.getRoute("routeId1000");
        Assert.assertEquals("XXXX", route1000.getBeginningPort());
        Assert.assertEquals("YYYYY", route1000.getArrivalPort());

        Assert.assertEquals(10, this.theShippingLine.numRoutes());

        this.theShippingLine.addRoute("routeId1000", "Livorno", "Cannes");
        route1000 = this.theShippingLine.getRoute("routeId1000");
        Assert.assertEquals("Livorno", route1000.getBeginningPort());
        Assert.assertEquals("Cannes", route1000.getArrivalPort());

        Assert.assertEquals(10, this.theShippingLine.numRoutes());

        this.theShippingLine.addRoute("routeId2000", "Izmir", "Rodas");

        Assert.assertEquals(11, this.theShippingLine.numRoutes());
    ...
    public void getMostTraveledRouteTest() throws DSException {
        ...
        Assert.assertEquals("Marsella-Túnez", route.toString());
